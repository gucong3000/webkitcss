...
var zNodes = [
...

	{
		...
		id: 412,
		pId: 41,
		name: "-webkit-wrap-margin"
	}, {
		id: 413,
		pId: 41,
		name: "-webkit-wrap-padding"
	}, {
		id: 414,
		pId: 41,
...
$(function() {
	...
	$("#main").on("click", "#viewCode", function(e) {
		if (!(window.netscape || window.chrome)) {
			event.preventDefault();
			prompt("您的浏览器不支持查看源代码，请自行打开源代码", $("#iframedemo").prop("src"));
		}
	});
});